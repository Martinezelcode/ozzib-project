            ...
            {isLoading ? (
              ...
              <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
                <CardContent className="text-center py-12">
                  <i
                    className="fas fa-user-friends text-4xl mb-4"
                    style={{ color: "#7440ff" }}
                  ></i>
              ...
              <div className="space-y-2">
                {acceptedFriends.map((friend: any) => {
                  ...
                  return (
                    <div
                      key={friend.id}
                      className="flex items-center justify-between p-2 md:p-3 bg-white dark:bg-slate-800 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors border border-slate-200 dark:border-slate-700"
                    >
                      <div className="flex items-center space-x-2 md:space-x-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mb-1">
                            <Badge className="bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 text-xs px-2 py-0.5">
                              Online
                            </Badge>
                          ...
                          <div className="flex items-center gap-1.5">
                            <div className="flex items-center gap-1 px-1.5 py-0.5 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 rounded-full text-xs">
                              ...
                              <span className="font-medium">{friendUser.eventsWon || 0}</span>
                            </div>
                            <div className="flex items-center gap-1 px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 rounded-full text-xs">
                              ...
                              <span className="font-medium">{friendUser.challengesWon || 0}</span>
                            </div>
                            <div className="flex items-center gap-1 px-1.5 py-0.5 bg-amber-100 dark:bg-amber-900 text-amber-700 dark:text-amber-300 rounded-full text-xs">
                              <span className="text-xs">💰</span>
                              <span className="font-medium">{friendUser.coins?.toLocaleString() || 0}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center space-x-2 md:space-x-3 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5">
                          <div className="flex items-center gap-1 px-1.5 py-0.5 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 rounded-full text-xs">
                            <span className="text-xs">🏆</span>
                            <span className="font-medium">{user.eventsWon || 0}</span>
                          </div>
                          <div className="flex items-center gap-1 px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 rounded-full text-xs">
                            <span className="text-xs">⚔️</span>
                            <span className="font-medium">{user.challengesWon || 0}</span>
                          </div>
                          <div className="flex items-center gap-1 px-1.5 py-0.5 bg-amber-100 dark:bg-amber-900 text-amber-700 dark:text-amber-300 rounded-full text-xs">
                            <span className="text-xs">💰</span>
          ...
          <TabsContent value="sent" className="space-y-4">
            {sentRequests.length === 0 ? (
              <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
                <CardContent className="text-center py-12">
                  <i
                    className="fas fa-paper-plane text-4xl mb-4"
                    style={{ color: "#7440ff" }}
                  ></i>
                  <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2">
                    No sent requests
                  ...
                  >
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <UserAvatar
                            userId={addresseeUser.id}
                            username={addresseeUser.username || addresseeUser.email}
                            size={48}
                            className="w-12 h-12"
                          />
                          <div>
                            <h3 className="font-semibold text-slate-900 dark:text-slate-100">
                              {addresseeUser.firstName ||
