      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-1">
                          ...
                          >
                            <FormControl>
                              <SelectTrigger className="h-8 text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-600">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <Button
            ...
            className={`px-4 py-2 rounded-lg whitespace-nowrap ${selectedTab === 'map' ? 'bg-purple-600 text-white hover:bg-purple-700' : ''}`}
            onClick={() => setSelectedTab('map')}
            data-testid="tab-bant-map"
          >
            Bant MAP
          </Button>
          <Button
