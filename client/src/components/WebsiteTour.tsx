    ...
    <div className="fixed inset-0 z-[998]">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl overflow-hidden border-2 border-[#7440ff]/20"
        >
          {/* Progress bar */}
          ...
          <div className="p-5">
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <Button
                ...
                size="sm"
                onClick={handleSkip}
                className="h-8 w-8 p-0 ml-2 hover:bg-red-50 dark:hover:bg-red-900/20"
              >
                <X className="h-4 w-4" />
              </Button>
            </div>
